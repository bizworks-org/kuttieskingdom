    ...
    >
      <div className="max-w-[1200px] mx-auto px-4">
        <div className="grid md:grid-cols-2 gap-8">
          ...
          >
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3885.8735!2d80.2242!3d13.1234!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMTPCsDA3JzI0LjIiTiA4MMKwMTMnMjcuMSJF!5e0!3m2!1sen!2sin!4v1234567890"
              width="100%"
              height="400"
              style={{ border: 0 }}
              allowFullScreen
            ...
            <div className="space-y-6" style={{ fontFamily: "'Nunito', sans-serif" }}>
              ...
              <div>
                ...
                <p style={{ fontSize: '1rem', lineHeight: '1.6' }}>
                  No. 72/128, 1st Floor, Kamarajar Salai,<br />
                  Gandhi Nagar, Kodungaiyur,<br />
                  Chennai – 600 118
                </p>
              </div>
